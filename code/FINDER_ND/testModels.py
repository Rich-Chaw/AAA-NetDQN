...
def plot_max_cc_comparison(all_results, dataset, save_dir, model_configs):
    """
    ...
    plt.title(f'MaxCC Comparison on {dataset}')
...
def plot_best_iter_overview(all_model_results, eval_config, save_dir, model_configs, mode):
