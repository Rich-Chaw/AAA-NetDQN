...
setup(
    ...
    ext_modules = [
                   ...
                   Extension('graph', sources=['./FINDER_large/graph.pyx', './FINDER_large/src/lib/graph.cpp','./FINDER_large/src/lib/disjoint_set.cpp'], language='c++',extra_compile_args=['-std=c++11']),
