...
def main():
    ...
    parser.add_argument("--model_path", type=str, required=True,
                       help="Path to trained MoE model directory e.g. MoE_BA_nrange_50_100_m_6")
    ...
    if not os.path.exists(f"{model_config['save_model_dir']}/{args.model_path}"):
        print(f"Error: Model path does not exist: {model_config['save_model_dir']}/{args.model_path}")
        return 1
